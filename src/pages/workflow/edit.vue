  ...
  <div style="height: 100%">
      ...
      <a-col flex="320px" class="left_div">
        <div class="leftx">
          <a-row class="kzq">
            <a-col :span="6">
              <div
                class="tools_div center"
                @mousedown="
                  onDrag(
                    $event,
                    baseURL + '/app/basic/start.png',
                    '开始',
                    'start'
                  )
                "
              >
                <img
                  class="avatar_img"
                  :src="baseURL + '/app/basic/start.png'"
                />
            ...
            <a-col :span="6">
              <div
                class="tools_div center"
                @mousedown="
                  onDrag($event, baseURL + '/app/basic/end.png', '结束', 'end')
                "
              >
            ...
            <a-col :span="6">
              ...
              >
                <img
                  class="avatar_img"
                  :src="baseURL + '/app/basic/input.png'"
                />
            ...
            <a-col :span="6">
              ...
              >
                <img
                  class="avatar_img"
                  :src="baseURL + '/app/basic/webhook.png'"
                />
            ...
            <a-col :span="6">
              ...
              >
                <img
                  class="avatar_img"
                  :src="baseURL + '/app/basic/timer.png'"
                />
            ...
            <a-col :span="6">
              ...
              >
                <img
                  class="avatar_img"
                  :src="baseURL + '/app/basic/audit.png'"
                />
            ...
            <a-col :span="6">
              <div
                class="tools_div center"
                @mousedown="
                  onDrag($event, baseURL + '/app/basic/if.png', 'IF', 'if')
                "
              >
            ...
            <a-col :span="6">
              <div
                class="tools_div center"
                @mousedown="
                  onDrag($event, baseURL + '/app/basic/for.png', 'For', 'for')
                "
              >
          ...
          <a-button
            ...
            icon="profile"
            size="small"
            @mousedown="onDrag($event, '', 'Note', 'note')"
          >
            便 签
          </a-button>
          <!-- <div class="hr"></div> -->
            ...
            <a-col :span="6" v-for="(item, index) in app_list" :key="index">
              ...
              >
                <a-avatar
                  ...
                  :size="55"
                  :src="
                    baseURL + '/app/' + item.icon + '?t=' + new Date().getTime()
                  "
                />
            ...
            <div slot="content" class="edit_config">
              ...
              <div class="t1">
                ...
                <a-radio-group
                  ...
                  size="small"
                  :value="edge_marker"
                  @change="onChangEdgeMarker"
                >
                  <a-radio-button value="block"> 箭头1 </a-radio-button>
                  <a-radio-button value="classic"> 箭头2 </a-radio-button>
                  <a-radio-button value="circle"> 圆圈 </a-radio-button>
                  <a-radio-button value="diamond"> 方块 </a-radio-button>
                </a-radio-group>
              </div>
              <div class="t1">
                <span class="t2">颜色 :</span>
                <a-radio-group
                  default-value="#c7342e"
                  button-style="solid"
                  size="small"
                  :value="edge_color"
                  @change="onChangEdgeColor"
                >
              ...
              <div class="t1">
                ...
                <a-radio-group
                  ...
                  @change="onChangEdgeConnector"
                >
                  <a-radio-button value="normal"> 直角 </a-radio-button>
                  <a-radio-button value="rounded"> 圆角 </a-radio-button>
                  <a-radio-button value="smooth"> 平滑连线 </a-radio-button>
                </a-radio-group>
              </div>
              <div class="t1">
                ...
                <a-radio-group
                  ...
                  size="small"
                  :value="edge_router"
                  @change="onChangEdgeRouter"
                >
                  <a-radio-button value="normal"> 直线 </a-radio-button>
                  <a-radio-button value="orth"> 拐线 </a-radio-button>
                  <a-radio-button value="er"> 关系路由 </a-radio-button>
                  <a-radio-button value="metro"> 智能路由 </a-radio-button>
                </a-radio-group>
              </div>
              ...
              <div class="t1">
                ...
                >
                  ...
                  <a-radio-button value="dot"> 点 </a-radio-button>
                  <a-radio-button value="mesh"> 网格 </a-radio-button>
                </a-radio-group>
              </div>
            </div>
            <internal-data
      ...
      <a-form :form="form" layout="vertical" @submit="onUpdate">
        <a-row :gutter="16">
          <a-col :span="24" style="margin-bottom: 20px">
            <span style="font-weight: bold; margin-right: 10px">UUID : </span
            ><span class="uuidcss">{{ key }}</span>
          </a-col>
          ...
          <a-col :span="24">
            <a-form-item>
              ...
              <a-select
                ...
                placeholder="请选择执行动作"
                @change="selectAppAction"
              >
                <a-select-option
                  v-for="(item, index) in app_info.action"
                  :key="index"
                  :value="item.func"
    ...
    >
      <a-form :form="form_edge" layout="vertical" @submit="onUpdateEdge">
            ...
            <a-form-item label="链路说明">
              <a-input
                v-decorator="[
                  'edge_name',
                  {
                    rules: [{ max: 30, message: '链路说明长度不能超过30位' }],
                  },
                ]"
                placeholder="请输入链路说明"
              />
        ...
        >
          <a-button :style="{ marginRight: '8px' }" @click="onCloseEdge"
            >关闭</a-button
          >
          <a-button type="primary" html-type="submit"> 保存 </a-button>
        </div>
    ...
    >
      <a-form :form="form_timer" layout="vertical" @submit="onUpdateTimer">
        <a-row :gutter="16">
          ...
          <div class="timer_css">
            <a-col :span="24">
              <a-radio-group
                v-model="time_type"
                @change="onChangTimeType"
                button-style="solid"
                style="margin-bottom: 20px"
              >
                <a-radio-button value="date"> 定时执行 </a-radio-button>
                <a-radio-button value="interval"> 间隔执行 </a-radio-button>
                <a-radio-button value="cron"> 执行计划 </a-radio-button>
              </a-radio-group>
            </a-col>
            ...
            <div v-else-if="time_type == 'interval'">
              <a-col :span="24">
                <a-form-item label="间隔类型">
                  ...
                  >
                    <a-radio value="seconds"> 秒钟 </a-radio>
                    <a-radio value="minutes"> 分钟 </a-radio>
                    <a-radio value="hours"> 小时 </a-radio>
                    <a-radio value="days"> 天 </a-radio>
                    <a-radio value="weeks"> 周 </a-radio>
                  </a-radio-group>
                </a-form-item>
              </a-col>
              <a-col :span="24">
        ...
        >
          <a-button :style="{ marginRight: '8px' }" @click="onCloseTimer"
            >关闭</a-button
          >
          <a-button type="primary" html-type="submit"> 保存 </a-button>
        </div>
    ...
    >
      <a-form :form="form_for" layout="vertical" @submit="onUpdateFor">
            ...
            <a-form-item label="循环数据">
              <a-textarea
                v-decorator="[
                  'text',
                  {
                    rules: [{ max: 500, message: '循环数据不能超过500位' }],
                  },
                ]"
                placeholder="请输入数据"
              />
        ...
        >
          <a-button :style="{ marginRight: '8px' }" @click="onCloseFor"
            >关闭</a-button
          >
          <a-button type="primary" html-type="submit"> 保存 </a-button>
        </div>
    ...
    >
      <a-form :form="form_if" layout="vertical" @submit="onUpdateIf">
            ...
            <a-form-item label="判断条件">
              <a-textarea
                v-decorator="[
                  'text',
                  {
                    rules: [{ max: 500, message: '条件长度不能超过500位' }],
                  },
                ]"
                placeholder="请输入条件"
              />
        ...
        >
          <a-button :style="{ marginRight: '8px' }" @click="onCloseIf"
            >关闭</a-button
          >
          <a-button type="primary" html-type="submit"> 保存 </a-button>
        </div>
    ...
    >
      <a-form :form="form_audit" layout="vertical" @submit="onUpdateAudit">
            ...
            <a-form-item label="审核人">
              ...
              >
                <a-select-option
                  ...
                  :key="item.id"
                  :value="item.id"
                  >{{ item.nick_name }}</a-select-option
                >
              </a-select>
            </a-form-item>
          </a-col>
        ...
        >
          <a-button :style="{ marginRight: '8px' }" @click="onCloseAudit"
            >关闭</a-button
          >
          <a-button type="primary" html-type="submit"> 保存 </a-button>
        </div>
    ...
    >
      <a-tabs slot="title" default-active-key="2">
        ...
        <a-tab-pane key="2" tab="局部变量">
          <a-button
            style="position: absolute; z-index: 999; right: 40px; top: 5px"
            type="primary"
            shape="circle"
            icon="plus-circle"
            @click="onOpenLoclVarAdd"
          />
          <a-list
            class="sscx"
            :data-source="local_var_data"
              ...
              <div class="local-var-actipn">
                ...
                <a-tooltip placement="top">
                  ...
                  <a-icon
                    ...
                    type="form"
                    @click="
                      onOpenLoclVarEdit(item.key, item.value, item.remarks)
                    "
                  />
                </a-tooltip>
              </div>
    ...
    <a-modal
      ...
      cancelText="关闭"
      okText="确定"
      :visible="visible_local_var_add"
      @ok="onSaveLocalVar"
      @cancel="onCloseLoclVarAdd"
    >
      <a-row :gutter="16">
        <a-col :span="24">
    ...
    <a-modal
      ...
      cancelText="关闭"
      okText="确定"
      :visible="visible_local_var_edit"
      @ok="onUpdateLocalVar"
      @cancel="onCloseLoclVarEdit"
    >
      <a-row :gutter="16">
        <a-col :span="24">
          <a-form-item label="Key">
    ...
    <a-modal
      ...
      cancelText="关闭"
      okText="确定"
      :visible="visible_input_app_edit"
      @ok="onSaveInputEdit"
      @cancel="onCloseInputEdit"
    >
      <a-row :gutter="16">
        <a-col :span="24" style="margin-bottom: 20px">
          <span style="font-weight: bold; margin-right: 10px">UUID : </span
    ...
    <a-modal
      ...
      cancelText="关闭"
      okText="确定"
      :visible="visible_workflow_edit"
      @ok="onUpdatelWorkFlow"
      @cancel="onCloseLoclWorkFlow"
    >
      <a-row :gutter="16">
        <a-col :span="24">
    ...
    >
      <div id="report">
        <a-row :gutter="16" class="report" style="margin: auto">
          ...
          <a-col
            :span="24"
            v-for="(item, index) in report_log_data"
            :key="index"
            class="div2"
          >
            <a-descriptions :column="1" bordered size="small">
              ...
              >
                <div
                  v-for="(i, key, index) in item.args"
                  :key="index"
                  class="args_list"
                >
                  <div
                    ...
                    "
                  >
                    <div class="args_title">
                      <span class="jing">|</span> {{ key }}
                    </div>
                    <div>{{ i }}</div>
                  </div>
                </div>
              ...
              <a-descriptions-item
                label="结果"
                v-if="
                  item.app_name !== '用户输入' && item.app_name !== 'WebHook'
                "
              >
                <pre
                  v-html="item.html"
...
<script>
import { DataUri, Graph, Shape, Addon } from "@antv/x6";
  ...
  methods: {
    ...
    onRegister() {
      try {
        Graph.registerHTMLComponent("w5NodeDark", (node) => {
          ...
          this.convertImgToBase64(
            node.data.icon + "?t=" + new Date().getTime(),
            function (base64Img) {
              if (
                node.data.action == "" ||
                typeof node.data.action == "undefined" ||
                ...
                wrap.innerHTML =
                  `
                        <div class="w5Node" style="color: #ccc;text-align: center;">
                            <div class="` +
                  node.id +
                  `&tools" style="letter-spacing: 10px;visibility:hidden;">
                                <?xml version="1.0" encoding="UTF-8"?><svg onclick="onDeleteNode('` +
                  node.id +
                  `')" style="cursor: pointer;" width="16" height="16" viewBox="0 0 48 48" fill="none" xmlns="httdiv://www.w3.org/2000/svg"><rect width="48" height="48" fill="white" fill-opacity="0.01"/><path d="M9 10V44H39V10H9Z" fill="#858585" stroke="#858585" stroke-width="4" stroke-linejoin="round"/><path d="M20 20V33" stroke="#FFF" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/><path d="M28 20V33" stroke="#FFF" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/><path d="M4 10H44" stroke="#858585" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/><path d="M16 10L19.289 4H28.7771L32 10H16Z" fill="#858585" stroke="#858585" stroke-width="4" stroke-linejoin="round"/></svg>
                                <?xml version="1.0" encoding="UTF-8"?><svg onclick="onCopyNodeId('` +
                  node.id +
                  `','` +
                  node.data.name +
                  `')" style="cursor: pointer;" width="16" height="16" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M13 12.4316V7.8125C13 6.2592 14.2592 5 15.8125 5H40.1875C41.7408 5 43 6.2592 43 7.8125V32.1875C43 33.7408 41.7408 35 40.1875 35H35.5163" stroke="#858585" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/><path d="M32.1875 13H7.8125C6.2592 13 5 14.2592 5 15.8125V40.1875C5 41.7408 6.2592 43 7.8125 43H32.1875C33.7408 43 35 41.7408 35 40.1875V15.8125C35 14.2592 33.7408 13 32.1875 13Z" fill="#858585" stroke="#858585" stroke-width="4" stroke-linejoin="round"/></svg>
                            ...
                            <div class="w5Icon" style="width: 70px;height: 70px;border-radius: 20px;background: #fff;line-height: 65px;text-align: center;border: 1px solid #dbdbdb;">
                                <img crossorigin="anonymous" style="height: 75%;width: 75%;border-radius: 100%;" class="nodeImg" src="` +
                  base64Img +
                  `" alt="` +
                  node.data.name +
                  `">
                            ...
                            <div class="` +
                  node.id +
                  `&name" style="font-size: 13px;margin-top: 7px;font-weight: bold;">` +
                  node.data.name +
                  `</div>
                            <div class="` +
                  node.id +
                  `&action" style="font-size: 12px;color: #787878;"></div>
                        </div>
                        `;
              } else {
                wrap.innerHTML =
                  ...
                  `</div>
                            <div class="` +
                  node.id +
                  `&action" style="font-size: 12px;color: #787878;">` +
                  node.data.action +
                  `</div>
                        </div>
                        `;
              ...
              if (
                ...
                wrap.innerHTML =
                  ...
                  `</div>
                            <div class="` +
                  node.id +
                  `&action" style="font-size: 12px;color: #858585;"></div>
                        </div>
                        `;
              } else {
                wrap.innerHTML =
                  ...
                  `</div>
                            <div class="` +
                  node.id +
                  `&action" style="font-size: 12px;color: #858585;">` +
                  node.data.action +
                  `</div>
                        </div>
                        `;
      ...
      try {
        Graph.registerHTMLComponent("w5NodeNote", (node) => {
          ...
          wrap.innerHTML =
            `
                    <div style="position: absolute;right: 0px;margin-right: 5px;font-size: 20px;color: #505050;margin-top: -5px;cursor: pointer;" onclick="onDelNote('` +
            node.id +
            `')">x</div>
                    <div class="w5NodeNote" style="color: #4e4e4e;text-align: center;height: 200px;width: 200px;border-radius: 3px;background: linear-gradient(216deg,#fffc9f, #ffed33);font-size: 14px;overflow-x: hidden;overflow-y: auto;-webkit-user-modify: read-write-plaintext-only;outline: none;word-break: break-all;display: grid;align-items: center;justify-content: center;" spellcheck="false" onmouseout="onSaveNote('` +
            node.id +
            `')">` +
            node.data.text +
            `</div>
    ...
    onCanvasEvents() {
      ...
      that.graph.on("node:mouseenter", (e) => {
        ...
        let toolsElem = document
          .getElementById("container")
          .getElementsByClassName(select_tools)[0];
      ...
      that.graph.on("node:mouseleave", (e) => {
        ...
        document
          .getElementById("container")
          .getElementsByClassName(select_tools)[0].style.visibility = "hidden";
        document
          .getElementById("minimapContainer")
          .getElementsByClassName(select_tools)[0].style.visibility = "hidden";
      });
        ...
        if (typeof this.app_data[i] != "undefined") {
          if (this.app_data[i].hasOwnProperty("data") == false) {
            this.$message.warning(
              "请选择 [ " + this.app_data[i].name + " ] APP 动作"
            );
      ...
      this.$http
        ...
        .then((res) => {
          if (res.code == 0) {
            ...
            if (
              res.data.flow_data === "none" ||
              res.data.flow_data.trim() === "" ||
              res.data.flow_data.trim() === "{}"
            ) {
              this.app_data = {};
            } else {
            ...
            if (
              res.data.local_var_data === "none" ||
              res.data.local_var_data.trim() === "" ||
              res.data.local_var_data.trim() === "[]"
            ) {
              this.local_var_data = [];
            } else {
            ...
            if (
              res.data.controller_data === "none" ||
              res.data.controller_data.trim() === "" ||
              res.data.controller_data.trim() === "{}"
            ) {
    ...
    onAppList() {
      // 加载 APP 列表
      this.$http.get("/api/v1/soar/get/app/list").then((res) => {
        if (res.code == 0) {
    ...
    onUpdate(e) {
      ...
      this.form.validateFields((err, values) => {
        if (!err) {
          ...
          if (this.curr_theme === "bright") {
            this.graph
              .findViewByCell(this.key)
              .cell.setProp("html", "w5NodeDark");
            this.graph
              .findViewByCell(this.key)
              .cell.setProp("html", "w5NodeBright");
          } else if (this.curr_theme === "dark") {
            this.graph
              .findViewByCell(this.key)
              .cell.setProp("html", "w5NodeBright");
    ...
    onUpdateEdge(e) {
      ...
      this.form_edge.validateFields((err, values) => {
        if (!err) {
          this.graph
            .findViewByCell(this.key)
            .cell.setLabels([values.edge_name]);
          this.onSave();
          this.onCloseEdge();
        }
      });
        ...
        if (!err) {
          ...
          if (this.time_type == "date") {
            ...
            if (
              ...
              values.start_date = this.Dayjs(values.start_date).format(
                "YYYY-MM-DD HH:mm:ss"
              );
            }
            ...
            if (
              ...
              values.end_date = this.Dayjs(values.end_date).format(
                "YYYY-MM-DD HH:mm:ss"
              );
            }
      ...
      this.form_audit.validateFields((err, values) => {
        if (!err) {
          ...
          this.user_list.forEach((user) => {
            if (String(values.text) === String(user.id))
              action_name = user.nick_name;
          });
    ...
    onShowMd() {
      ...
      let md_url =
        "/app/" + app_info["app_dir"] + "/readme.md?t=" + new Date().getTime();

      this.$http.get(md_url).then((res) => {
        this.app_title =
          app_info["name"] +
          " v" +
          app_info["version"] +
...
- **每天10点开始1小时执行一次：** \`* 10/1 * * 0-5\`
    ...
    onGetPlacement() {
      this.$http.post("/api/v1/soar/get/system/placement").then((res) => {
        if (res.code == 0) {
    ...
    onUserList() {
      this.$http.post("/api/v1/soar/get/user/simple_list").then((res) => {
        if (res.code == 0) {
